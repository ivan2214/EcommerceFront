...
const Filters = () => {
  ...
  return (
    <section className='flex flex-col gap-5 md:justify-between  overflow-hidden p-5 md:w-full md:flex-row lg:justify-start   lg:min-h-screen lg:max-w-sm lg:flex-col lg:gap-16 lg:p-10'>
