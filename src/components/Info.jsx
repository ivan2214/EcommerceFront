...
const Info = () => {
  ...
  return (
    <section className='mx-auto flex h-full w-full max-w-6xl flex-col  py-5 px-5 lg:px-0'>
      <h2 className='text-left text-3xl font-bold text-purple-700 '>Nuestros Servicios</h2>
      <article className='flex h-full w-full flex-col items-center justify-start gap-10 p-10 lg:flex-row'>
